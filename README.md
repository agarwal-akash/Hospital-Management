...
* To run the application [click here](https://github.com/agarwal-akash/Hospital-Management/tree/master/store) and use username:akash password:12345 to open the application.
